const ORDER_API = "/api/orders/myorders/";
const DELETE_API = "/api/orders/";
  ...
  try {
    ...
    orders.forEach(order => {
      ...
      img.src = listing.photo
        ? (listing.photo.startsWith("http") ? listing.photo : `${listing.photo}`)
        : PLACEHOLDER_URL;
      ...
      status.textContent = order.paid ? "Оплачено" : "Очікування оплати";
